from utils.config import BASE_URL_LOGIN, get_headers, BASE_URL, PLATFORM, log
...
class LoginJourney:
    ...
    def code_api(self):
        ...
        resp = self.client.post(BASE_URL_LOGIN + code_url, headers=headers, data=data)
    ...
    def subject_api(self):
        ...
        resp = self.client.post(BASE_URL_LOGIN + subject_url, headers=headers, data=data , name = "Subject_API_Login")
